    ...
    <div className="relative">
      ...
      >
       ...
       <Dropdown
          ...
          className="absolute left-2 right-4 mt-3 flex h-[480px] w-[calc(85vw-32px)] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] sm:left-1lg:right-0 lg:left-auto"
>
